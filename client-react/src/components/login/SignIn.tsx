...
//                 const res = await axios.post<RegisterResponse>('https://fullstack-project-tt0t.onrender.com/api/Auth/register', {
...
//                     }
//                 });
//                 // const response = await axios.post('https://fullstack-project-tt0t.onrender.com/api/Auth/register', {
